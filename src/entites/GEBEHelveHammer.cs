...
{
    public class GEBEHelveHammer : BlockEntity, ITexPositionSource
    {
        int count = 40;
        bool obstructed;

        GEBEBehaviorMPToggle mptoggle;
        ...
        GEHelveHammerRenderer renderer;
        ...
        void setRenderer()
        {
            ...
            {
                renderer = new GEHelveHammerRenderer(Api as ICoreClientAPI, this, Pos, GenHammerMesh());
        ...
        private void onEvery25ms(float dt)
        {
            if (count >= 40)
            {
                ...
                targetAnvil = Api.World.BlockAccessor.GetBlockEntity(Pos.AddCopy(dir.X * 3, 0, dir.Z * 3)) as GEBEAnvil;
                ...
                mptoggle = Api.World.BlockAccessor.GetBlockEntity(Pos.AddCopy(dir))?.GetBehavior<GEBEBehaviorMPToggle>();
