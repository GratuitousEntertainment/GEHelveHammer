...
namespace gehelvehammer.src.itemtypes
{
    public class GEItemHammer : Item
    {
        SkillItem[] toolModes;
        ...
        public override void OnHeldAttackStart(ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, ref EnumHandHandling handling)
        {
            ...
            if (!(byEntity.World.BlockAccessor.GetBlock(blockSel.Position) is GEBlockAnvil)) return;

            GEBEAnvil bea = byEntity.World.BlockAccessor.GetBlockEntity(blockSel.Position) as GEBEAnvil;
            if (bea == null) return;
        ...
        public override SkillItem[] GetToolModes(ItemSlot slot, IClientPlayer forPlayer, BlockSelection blockSel)
        {
            ...
            return block is GEBlockAnvil ? toolModes : null;
        }
