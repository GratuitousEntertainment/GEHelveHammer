...
{
    public class GEBlockAnvil : Block
    {
                ...
                return new WorldInteraction[] {
                    new WorldInteraction()
                    {
                        ...
                        GetMatchingStacks = (wi, bs, es) => {
                            GEBEAnvil bea = api.World.BlockAccessor.GetBlockEntity(bs.Position) as GEBEAnvil;
        ...
        public override void OnDecalTesselation(IWorldAccessor world, MeshData decalMesh, BlockPos pos)
        {
            ...
            GEBEAnvil bect = world.BlockAccessor.GetBlockEntity(pos) as GEBEAnvil;
            if (bect != null)
            {
        ...
        {
            GEBEAnvil bea = blockAccessor.GetBlockEntity(pos) as GEBEAnvil;
            if (bea != null)
            {
        ...
        {
            GEBEAnvil bea = world.BlockAccessor.GetBlockEntity(blockSel.Position) as GEBEAnvil;
            if (bea != null)
            {
        ...
        public override bool DoPlaceBlock(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel, ItemStack byItemStack)
        {
            ...
            if (val)
            {
                GEBEAnvil bect = world.BlockAccessor.GetBlockEntity(blockSel.Position) as GEBEAnvil;
                if (bect != null)
                {
